...
import Illustration21Src1024 from '@snowui-design-system/resource-base/assets/illustrations/illustration-21-1024.png';
  ...
  let { width, height = 128, alt = "Illustration21", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Illustration21AvailableWidths));
