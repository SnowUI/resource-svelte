...
import Illustration24Src1024 from '@snowui-design-system/resource-base/assets/illustrations/illustration-24-1024.png';
  ...
  let { width, height = 128, alt = "Illustration24", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Illustration24AvailableWidths));
