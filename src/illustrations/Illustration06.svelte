...
import Illustration06Src1024 from '@snowui-design-system/resource-base/assets/illustrations/illustration-06-1024.png';
  ...
  let { width, height = 128, alt = "Illustration06", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Illustration06AvailableWidths));
