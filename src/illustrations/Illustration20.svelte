...
import Illustration20Src1024 from '@snowui-design-system/resource-base/assets/illustrations/illustration-20-1024.png';
  ...
  let { width, height = 128, alt = "Illustration20", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Illustration20AvailableWidths));
