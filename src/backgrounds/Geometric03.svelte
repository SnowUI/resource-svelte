...
import Geometric03Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/geometric-03-1920.jpg';
  ...
  let { width, height = 128, alt = "Geometric03", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Geometric03AvailableWidths));
