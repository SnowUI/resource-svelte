...
import Gradient02Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/gradient-02-1920.jpg';
  ...
  let { width, height = 128, alt = "Gradient02", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Gradient02AvailableWidths));
