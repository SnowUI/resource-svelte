...
import Gradient07Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/gradient-07-1920.jpg';
  ...
  let { width, height = 128, alt = "Gradient07", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Gradient07AvailableWidths));
