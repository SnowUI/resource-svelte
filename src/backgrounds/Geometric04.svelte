...
import Geometric04Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/geometric-04-1920.jpg';
  ...
  let { width, height = 128, alt = "Geometric04", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Geometric04AvailableWidths));
