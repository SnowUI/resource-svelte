...
import Gradient13Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/gradient-13-1920.jpg';
  ...
  let { width, height = 128, alt = "Gradient13", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Gradient13AvailableWidths));
