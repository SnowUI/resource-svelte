...
import Gradient14Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/gradient-14-1920.jpg';
  ...
  let { width, height = 128, alt = "Gradient14", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Gradient14AvailableWidths));
