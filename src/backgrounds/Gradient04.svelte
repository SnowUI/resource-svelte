...
import Gradient04Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/gradient-04-1920.jpg';
  ...
  let { width, height = 128, alt = "Gradient04", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Gradient04AvailableWidths));
