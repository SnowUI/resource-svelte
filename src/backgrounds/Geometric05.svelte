...
import Geometric05Src1920 from '@snowui-design-system/resource-base/assets/backgrounds/geometric-05-1920.jpg';
  ...
  let { width, height = 128, alt = "Geometric05", class: className = "", ...rest }: BackgroundProps = $props();
  ...
  let closestWidth = $derived(findClosestWidth(sourceWidth, Geometric05AvailableWidths));
